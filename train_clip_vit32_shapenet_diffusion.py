...
def main():
    ...
    train_dataset = ShapeNet(train_path, 'plane')
    # val_dataset = ShapeNet(train_path, 'plane')
    ...
    while True:
        ...
        for i, batch_data in enumerate(progress_bar):
            ...
            # Forward
            loss = model.forward_train(batch_data['points'], batch_data['seg_img'], batch_data['prompt'], processor, clipModel)
