...
def rpmnet_arguments():
    ...
    parser.add_argument('--dataset_type', default='modelnet_hdf',
                        choices=['modelnet_hdf', 'bunny', 'armadillo', 'buddha', 'dragon', 'cs'],
...
def rpmnet_train_arguments():
    ...
    parser.add_argument('--train_categoryfile', type=str, metavar='PATH', default='./modelnet/data_loader/modelnet40_half1.txt',
                        help='path to the categories to be trained')  # eg. './dataset/modelnet40_half1.txt'
    parser.add_argument('--val_categoryfile', type=str, metavar='PATH', default='./modelnet/data_loader/modelnet40_half1.txt',
